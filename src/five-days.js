...
function displayOne(forecast) {
    ...
    const min = document.querySelector(".min-one");
    ...
    min.textContent = `Min: ${forecast.list[3].main.temp_min}°`;
}
...
function displayTwo(forecast) {
    ...
    const min = document.querySelector(".min-two");
    ...
    min.textContent = `Min: ${forecast.list[11].main.temp_min}°`;
}
...
function displayThree(forecast) {
    ...
    const min = document.querySelector(".min-three");
...
function displayFour(forecast) {
    ...
    const min = document.querySelector(".min-four");
    ...
    min.textContent = `Min: ${forecast.list[27].main.temp_min}°`;
}
...
function displayFive(forecast){
    ...
    const min = document.querySelector(".min-five");
    ...
    min.textContent = `Min: ${forecast.list[35].main.temp_min}°`;
}
